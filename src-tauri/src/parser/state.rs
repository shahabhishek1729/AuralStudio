use crate::parser::address::{Address, Addressable};
use crate::parser::parser::NodeKind;
use crate::Node;
use anyhow;
...
mod tests {
    ...
    use crate::parser::state::{CursorError::InvalidMotion, CursorState};
    ...
    macro_rules! move_cursor {
        ...
        (U) => {$crate::parser::state::CursorDir::UP};
        (D) => {$crate::parser::state::CursorDir::DOWN};
        (L) => {$crate::parser::state::CursorDir::LEFT};
        (R) => {$crate::parser::state::CursorDir::RIGHT};
        (I) => {$crate::parser::state::CursorDir::IN};
        (O) => {$crate::parser::state::CursorDir::OUT};
    }
